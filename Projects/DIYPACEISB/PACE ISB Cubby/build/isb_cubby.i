...
# 1 "Microchip.PIC16Fxxx_DFP.1.7.162/xc8\\pic\\include/pic.inc" 1 3



# 1 "Microchip.PIC16Fxxx_DFP.1.7.162/xc8\\pic\\include/pic_as_chip_select.inc" 1 3
# 369 "Microchip.PIC16Fxxx_DFP.1.7.162/xc8\\pic\\include/pic_as_chip_select.inc" 3
# 1 "Microchip.PIC16Fxxx_DFP.1.7.162/xc8\\pic\\include\\proc/pic16f88.inc" 1 3
# 47 "Microchip.PIC16Fxxx_DFP.1.7.162/xc8\\pic\\include\\proc/pic16f88.inc" 3
INDF equ 0000h
...
EECON2 equ 018Dh
# 1680 "Microchip.PIC16Fxxx_DFP.1.7.162/xc8\\pic\\include\\proc/pic16f88.inc" 3
...
# 370 "Microchip.PIC16Fxxx_DFP.1.7.162/xc8\\pic\\include/pic_as_chip_select.inc" 2 3
# 5 "Microchip.PIC16Fxxx_DFP.1.7.162/xc8\\pic\\include/pic.inc" 2 3
...
;-------------------------------------------------
CONFIG "FOSC" = "INTOSCIO" ; Internal RC, ((PORTA) and 07Fh), 6/((PORTA) and 07Fh), 7 as I/O
CONFIG "WDTE" = "OFF" ; Watchdog Timer disabled
CONFIG "PWRTE" = "OFF" ; Power-up Timer disabled
CONFIG "MCLRE" = "OFF" ; ((PORTA) and 07Fh), 5/MCLR/VPP pin function is digital I/O, MCLR internally tied to VDD
CONFIG "BOREN" = "OFF" ; Brown-out Reset disabled
CONFIG "LVP" = "OFF" ; High-voltage programming must be used to program the IC - ((PORTB) and 07Fh), 3 is digital IO
CONFIG "CPD" = "OFF" ; Data EEPROM code protection off
CONFIG "WRT" = "OFF" ; Flash write protection off
CONFIG "DEBUG" = "OFF" ; In-Circuit Debugger disabled, ((PORTB) and 07Fh), 6 and ((PORTB) and 07Fh), 7 are general purpose I/O pins
CONFIG "CCPMX" = "RB0" ; CCP1 on ((PORTB) and 07Fh), 0
...
main:
    ...
    banksel TRISA
    bcf TRISA, 7 ; ((PORTA) and 07Fh), 7 = sensor pin
    bcf TRISB, 3 ; ((PORTB) and 07Fh), 3 = onboard LED
    bcf TRISB, 6 ; ((PORTB) and 07Fh), 6 = UART debug output
    bcf TRISB, 7 ; ((PORTB) and 07Fh), 7 = ISB cubby output
...
continue:
    ...
    call duart
    btfss PORTA, 7 ; If ((PORTA) and 07Fh), 7 = 1 -> goto wait, ((PORTA) and 07Fh), 7 = 0 -> goto iron_on
    goto iron_on
    goto wait
iron_off: ; Soldering iron is resting in the holder
    ...
    bsf PORTB, 7
    banksel TRISB
    bsf TRISB, 7 ; HiZ on ((PORTB) and 07Fh), 7, simulate switch opening
    goto loop
